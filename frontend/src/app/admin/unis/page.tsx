  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-8 text-center">
      <div className="w-16 h-16 bg-[#1a2f5e]/5 rounded-2xl flex items-center justify-center mx-auto mb-4">
        <Award size={28} className="text-[#1a2f5e]" />
      </div>
      <h2 className="text-xl font-bold text-[#1a2f5e] mb-2">University Management</h2>
      <p className="text-gray-500 text-sm max-w-sm mx-auto mb-6">
        Add, edit and remove partner universities. Manage rankings, courses, and scholarship links.
      </p>

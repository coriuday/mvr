...
fn build_prompt(req: &SopReviewRequest) -> String {
    ...
    format!(
        r#"You are a senior admissions consultant with  years of experience reviewing Statements of Purpose (SOPs) for international students applying to universities in {country_ctx}. You have deep knowledge of what admissions committees at top universities look for.

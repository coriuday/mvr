use crate::{routes::AppState, services::admin_service::AdminService, utils::errors::AppResult};
...
pub async fn get_recent_leads(State(state): State<AppState>) -> AppResult<Json<serde_json::Value>> {
